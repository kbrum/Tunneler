...
- **Sem `export default`:** Use apenas _Named Exports_. Isso garante que o nome do componente seja consistente em todo o projeto e facilita refatoração.
...
- _Motivo:_ Evita problemas em sistemas operacionais case-sensitive (Linux).
