...
### 4. `controller/` (Interface Adapters / Wails IPC)
...
### `app.go`
*   **Função:** Orquestrador do Ciclo de Vida (Startup/Shutdown). Centraliza a inicialização dos Controllers (`controller`) e gerencia o contexto da aplicação.
